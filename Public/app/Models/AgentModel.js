(function() {
  ...
  AgentModel.prototype = Object.create(Super.prototype);
  ...
  AgentModel.prototype.save = function() {
    //save to indexdb only when all required fields are filled
  };

  AgentModel.prototype.inspect = function() {
    return {
  ...
  AgentModel.find = function(findParamsObj) {
